#!/usr/bin/env python3
"""
Generate speechPersona proposals for philosopher cards with DeepSeek.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate reviewed speechPersona proposals with DeepSeek.")
...
def build_review_output(
    ...
    return {
        "metadata": {
            "source": "deepseek_speech_persona_generation",
            "model": model,
