...
DEFAULT_RELATIONS = ROOT / "data" / "generated" / "reviewed_graph_relations.json"
...
def main() -> None:
    ...
    relations = load_existing_relations(args.relations, philosopher_ids={card["id"] for card in cards})
    output = build_data_js(cards, relations, dimensions=card_bundle.get("dimensions") or DEFAULT_DIMENSIONS)
